...
$motdepasse = "qnd753";
    ...
    if( isset($_POST['id_med']) && $_POST['id_med']!='' )
    {
        ...
        $requete_medecin = 'SELECT id_med,nom_med,prenom_med,id_cal,date_rdv,horaire_debut,motif,confirmation FROM Medecin,Calendrier WHERE id_med='.$id_med.' AND id_med=id_cal';
